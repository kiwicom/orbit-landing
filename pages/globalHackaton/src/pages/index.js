...
<<<<<<< HEAD
  <StyledWrapper>
    ...
    <Mission
      ...
      description={
        <>
          We’re inviting everyone to <b>redefine the travel experience.</b> How?
          We want to engage people by organising hackathons all over the world
          on 27 September. We will bring together engineers, designers, travel
          innovators, and others, offer them a creative and supportive
    ...
    <Prizes
      ...
      description={
        <>
          The winning team of each local hackathon will be invited to explore
          Prague with Kiwi.com. <br /> Look forward to a weekend full of fun
          activities and a party. The accommodation and travel costs are on us.
          <br />
    ...
    <Contact
      ...
      leftSectionDescription={
        <>
          ...
          drop us a line at globalhack@kiwi.com.
        </>
      }
...
=======
  <OrbitLanding>
    ...
    perspective."
      ...
      <Prizes
        ...
        description={
          <>
            The winning team of each local hackathon will be invited to explore
            Prague with Kiwi.com. <br /> Look forward to a weekend full of fun
            activities and a party. The accommodation and travel costs are on
            us.
            <br />
            <b>+ Invitation for the Kiwi.com party (December 2019)</b>
          </>
      ...
      />
>>>>>>> Update: New version of orbit plus own theme provider
